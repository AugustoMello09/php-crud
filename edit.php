...
$id = $_GET['id'];
  ...
  if(isset($_POST['submit'])) {
    ...
    $sql = "UPDATE `php` SET `first_name`='$first_name',`last_name`='$last_name',`email`='$email',`gender`='$gender' WHERE id=$id";
...
<body>
  ...
  <div class="container">
      ...
      <div class="text-center mb-4">
        ...
        <p class="text-muted"> Click em atualizar ao mudar qualquer informação</p>
      </div>

      <?php 
      $sql = "SELECT * FROM `php` WHERE id = $id LIMIT 1";
      $result = mysqli_query($conn, $sql);
